...
* [数据模型]()
  ...
  * [数据建模概念]()
    * [数据模型设计](docs/12-Data-Models/Data-Modeling-Concepts/Data-Model-Design.md)
    * [运营因素和数据建模](docs/12-Data-Models/Data-Modeling-Concepts/Operational-Factors-and-Data-Models.md)
  * [数据模型示例和模式]()
    * [文档之间的模型关系]()
      * [与嵌入式文档建立一对一关系模型](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Relationships-Between-Documents/Model-One-to-One-Relationships-with-Embedded-Documents.md)
      * [与嵌入式文档建立一对多关系模型](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Relationships-Between-Documents/Model-One-to-Many-Relationships-with-Embedded-Documents.md)
      * [使用文档参考建立一对多关系模型](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Relationships-Between-Documents/Model-One-to-Many-Relationships-with-Document-References.md)
    * [模型数结构]()
      * [具有父级引用的模型数结构](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Tree-Structures/Model-Tree-Structures-with-Parent-References.md)
      * [具有子级引用的模型数结构](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Tree-Structures/Model-Tree-Structures-with-Child-References.md)
      * [具有被继承的数据数结构](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Tree-Structures/Model-Tree-Structures-with-an-Array-of-Ancestors.md)
      * [具有实体化路径的模型数结构](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Tree-Structures/Model-Tree-Structures-with-Materialized-Paths.md)
      * [具有嵌套组的模型数结构](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Tree-Structures/Model-Tree-Structures-with-Nested-Sets.md)
    * [模型特定的应用程序上下文]()
      * [为原子操作建模数据](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Specific-Application-Contexts/Model-Data-for-Atomic-Operations.md)
      * [支持关键字搜索的建模数据](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Specific-Application-Contexts/Model-Data-to-Support-Keyword-Search.md)
      * [模式版本化的建模数据](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Specific-Application-Contexts/Model-Data-for-Schema-Versioning.md)
      * [模型货币数据](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Specific-Application-Contexts/Model-Monetary-Data.md)
      * [模型时间数据](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Specific-Application-Contexts/Model-Time-Data.md)
      * [模型计算数据](docs/12-Data-Models/Data-Model-Examples-and-Patterns/Model-Specific-Application-Contexts/Model-Computed-Data.md)
  * [数据参考模型]()
