# 将辅助节点转换为仲裁节点[![img](https://www.mongodb.com/docs/manual/assets/link.svg)](https://www.mongodb.com/docs/manual/tutorial/convert-secondary-into-arbiter/#convert-a-secondary-to-an-arbiter)
