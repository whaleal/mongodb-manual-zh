...
在这个 example 中，[聚合管道](core-aggregation-pipeline.htmlid1)包含[$group](reference-operator-aggregation-group.htmlpipe._S_group)阶段，后跟另一个[$group](reference-operator-aggregation-group.htmlpipe._S_group)阶段：
